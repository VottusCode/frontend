<template>
  <div class="flex justify-start items-center w-full h-full">
    <div class="mx-2 md:mx-8 lg:mx-20 grid grid-cols-3 w-full h-full">
      ...
      >
        <h1 class="title md:text-6xl" data-text="Vottus" style="line-height: 1">
          Vottus
        </h1>
        <h2 class="mt-4 text-gray-600 text-3xl">
          Fullstack
          <span class="text-purple-600 font-bold"> Website Developer </span>
        </h2>

        <div class="font-thin text-gray-700 text-2xl mt-8">
          <div>
            Hello! I'm <strong>Filip Vottus</strong>, a
            <strong>fullstack web developer</strong> from Prague!
            ...
            <div class="mt-8">
              ...
              <div class="mt-3 ml-4">
                <ul class="links">
                  ...
                  <li>
                    <a href="https://linkedin.com/vottus">LinkedIn</a> (not
                    updated)
                  </li>
                </ul>
              </div>
            ...
            <div class="mt-20 text-gray-500">
              2020 &copy; Vottus &ndash; All Rights Reserved
            </div>
          </div>
        </div>
      </div>
